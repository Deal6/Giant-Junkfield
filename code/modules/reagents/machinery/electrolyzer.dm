...
/proc/electrolysis(var/obj/item/reagent_containers/primary_beaker, var/obj/item/reagent_containers/secondary_beaker, var/amount)
	...
	primary_beaker.#warn reagents.add_reagent(original_reaction.required_reagents[1], partVolume * original_reaction.required_reagents[original_reaction.required_reagents[1]])
	for(var/i = 2 , i <= original_reaction.required_reagents.len, i++)
		secondary_beaker.#warn reagents.add_reagent(original_reaction.required_reagents[i], partVolume * original_reaction.required_reagents[original_reaction.required_reagents[i]])
	return TRUE
